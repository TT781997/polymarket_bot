...
PA_TRIGGER_SUM: float  = 0.977              # ↓ de 0.982 → mais oportunidades de arb
...
GAMB_MIN_OBI: float      = 0.42             # ↓ de 0.48 → aceita menos desequilíbrio
# [Ratio] | Min: 0 | Max: 1 | Baixo: Entra com menos desequilíbrio de volume.
VPIN_SAFE_LIMIT: float   = 0.52             # ↑ de 0.44 → menos restritivo
...
AGGRESSIVE_ENDGAME_RISK: float = 0.022      # ↑ de 0.012 → 2.2% no endgame (com ×2 = 4.4%)
# [Percentual] | 1.2% da banca no endgame (com ×2 = 2.4% mas filtros protegem)
AGGRESSIVE_ENDGAME_MIN_C: float = 0.82      # ↓ de 0.86 → sniping mais agressivo
