...
#
POLL_INTERVAL_S       = 10.0   # Intervalo entre polls REST (seg) [Range: 5.0 | 60.0]
POLL_MAX_DURATION_S   = 900.0  # Duração máxima do poller (seg) [Range: 120.0 | 1200.0]
POLL_REQUEST_TIMEOUT_S = 5.0  # Timeout por pedido REST (seg) [Range: 5.0 | 30.0]
...
RESOLVE_MAX_WAIT_S = 900.0  # Safety net: tempo maximo a aguardar market_resolved WS (seg) [Range: 120.0 | 1200.0]
